...
1.9.5  Version no longer requires manual file swapping.
Fixed i3 xstartup and aded firs version of settings and app search also created .deb file.

1.9  Version no longer requires manual file swapping.
Fixed critical bugs and improved script clarity.

1.8.5  Version no longer requires manual file swapping.
Fixed .sh and changed config. Next desktop planed in 1.9 version.

1.8  Version no longer requires manual file swapping.
Go to changelog. This version is backup before bigger changes on .sh part .

1.7.5.5 Version no longer requires manual file swapping. Changes in .sh and config files check commits or change log.

1.7.5  Version no longer requires manual file swapping.
...
1.7 Version no longer requires manual file swapping.
...
0.1.7 Version no longer requires manual file swapping.
Test verion dont use!

1.6-1.7 Version no longer requires manual file swapping.THIS IS TEST VERSION READ VERSION DESCRIPTION ON RELEASES PAGE.

1.6 Version no longer requires manual file swapping.
...
1.3.5 Version requires installed Ubuntu and manual file swapping.
Another key changes added to ripuntu.sh .
...
1.0 Version is empty (Unreleased).
